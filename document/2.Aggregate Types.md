# Aggregate Types in Go

Aggregate types là các kiểu dữ liệu có khả năng chứa nhiều giá trị bên trong một biến duy nhất. Trong Go, hai aggregate types quan trọng nhất là:
